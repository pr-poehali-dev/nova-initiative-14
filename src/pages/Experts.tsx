...
const mentors = [
  {
    ...
    stamp: { spec: "Оснастка/КД", exp: "{N} лет", software: "КОМПАС / SW" },
  },
  {
    initials: "ДВ",
    name: "{Имя наставника 2}",
    ...
    stamp: { spec: "Технология/расчёты", exp: "{N} лет", software: "AutoCAD / КОМПАС" },
  },
  {
    initials: "ЕС",
    name: "{Имя наставника 3}",
    ...
    stamp: { spec: "CAD/CAE/ЕСКД", exp: "{N} лет", software: "SW / Ansys / КОМПАС" },
  },
  {
    initials: "МН",
    name: "{Имя наставника 4}",
    ...
    stamp: { spec: "Детали машин/редукторы", exp: "{N} лет", software: "КОМПАС-3D" },
  },
];
