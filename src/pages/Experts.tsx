    ...
    <main className="min-h-screen grid-bg">
      <section className="pt-28 pb-16 px-4 md:px-8 max-w-[1200px] mx-auto">
        <div className="drawing-frame p-6 md:p-10 relative">
          ...
          <p className="font-gost text-sm md:text-base max-w-2xl text-[var(--drawing-line-thin)] leading-relaxed">
            Все наставники&nbsp;&mdash; действующие инженеры&#8209;конструкторы и&nbsp;инженеры&#8209;технологи. Они работают на&nbsp;машиностроительных предприятиях Екатеринбурга и&nbsp;знают, как устроено реальное производство. Они понимают требования кафедр УрФУ, потому что сами их прошли.
          </p>
        </div>
      </section>
      ...
      <section className="pb-16 px-4 md:px-8 max-w-[1200px] mx-auto">
        ...
        <div className="drawing-frame p-6 md:p-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              <p className="font-gost text-sm text-[var(--drawing-line)] leading-relaxed mb-5">
                Команда практикующих инженеров с&nbsp;суммарным опытом более&nbsp;40&nbsp;лет в&nbsp;машиностроении. Каждый из&nbsp;нас сегодня работает на&nbsp;производственном предприятии&nbsp;&mdash; решает реальные конструкторские и&nbsp;технологические задачи, а&nbsp;не&nbsp;только преподаёт.
              </p>
              <p className="font-gost text-sm text-[var(--drawing-line)] leading-relaxed">
                Мы сами прошли защиту дипломных проектов в&nbsp;УрФУ, знаем требования кафедр и&nbsp;помним, с&nbsp;какими трудностями сталкиваются студенты. Это делает нашу помощь прикладной, а&nbsp;не&nbsp;теоретической.
              </p>
            </div>
          ...
          <div className="extension-line-h w-full my-8" />

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { num: "40+", label: "лет совокупного\nопыта в отрасли" },
              { num: "5+", label: "действующих\nинженеров в команде" },
              { num: "120+", label: "студентов\nпрошли наставничество" },
              { num: "94%", label: "допущены\nк защите" },
            ].map((s) => (
              <div key={s.label} className="text-center">
                <p className="font-gost-upright text-3xl md:text-4xl font-bold text-[var(--drawing-accent)] leading-none mb-1">
                  {s.num}
                </p>
                <p className="font-gost text-[10px] text-[var(--drawing-line-thin)] leading-snug whitespace-pre-line">
                  {s.label}
                </p>
              </div>
            ))}
