          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              <p className="font-gost text-sm text-[var(--drawing-line)] leading-relaxed mb-5">
                Команда практикующих инженеров в&nbsp;области машиностроения и&nbsp;механики. Каждый из&nbsp;нас сегодня работает на&nbsp;производственном предприятии&nbsp;&mdash; решает реальные конструкторские и&nbsp;технологические задачи, а&nbsp;не&nbsp;только преподаёт.
              </p>
      ...
      <section className="pb-16 px-4 md:px-8 max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {[
            ...
            {
              icon: "MessageSquare",
              text: "Формат связи выбирают наставник и ученик: видеозвонки, офлайн-встречи (Екатеринбург), удобный мессенджер для быстрых вопросов в рабочее время.",
            },
          ].map((item) => (
