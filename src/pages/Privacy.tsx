...
const sections = [
  ...
  },
  {
    ...
    text: "Вы имеете право: запросить информацию об обрабатываемых персональных данных, потребовать их уточнения, блокирования или уничтожения в\u00A0случае, если данные являются неполными, устаревшими или неточными. Для реализации своих прав напишите нам на {email} или в\u00A0Telegram @diplom_inzh. Мы обработаем запрос в\u00A0течение 30\u00A0дней.",
  },
  {
    num: "6",
  ...
  },
  {
    num: "7",
    title: "Контакты",
    text: "По всем вопросам, связанным с\u00A0обработкой персональных данных, вы можете обратиться: электронная почта\u00A0\u2014 {email}, Telegram\u00A0\u2014 @diplom_inzh. Оператор оставляет за собой право вносить изменения в\u00A0настоящую Политику. Новая редакция вступает в\u00A0силу с\u00A0момента её публикации на сайте.",
  },
];
