  ...
  const sections = [
    {
      ...
      text: "Диплом-Инж.рф (далее\u00A0\u2014 Оператор) обрабатывает персональные данные посетителей сайта в\u00A0соответствии с\u00A0Федеральным законом от 27.07.2006 \u2116\u00A0152\u2011ФЗ \u00ABО\u00A0персональных данных\u00BB. Настоящая Политика определяет порядок обработки персональных данных и\u00A0меры по обеспечению их безопасности. Оператор ставит своей целью соблюдение прав и\u00A0свобод человека и\u00A0гражданина при обработке его персональных данных.",
    },
    {
      num: "2",
    ...
    },
    {
      ...
      text: `Вы имеете право: запросить информацию об обрабатываемых персональных данных, потребовать их уточнения, блокирования или уничтожения в\u00A0случае, если данные являются неполными, устаревшими или неточными. Для реализации своих прав напишите нам в\u00A0Telegram ${c.telegram}. Мы обработаем запрос в\u00A0течение 30\u00A0дней.`,
    },
    {
      num: "6",
    ...
    },
    {
      num: "7",
      title: "Контакты",
      text: `По всем вопросам, связанным с\u00A0обработкой персональных данных, вы можете обратиться: Telegram\u00A0\u2014 ${c.telegram}, телефон\u00A0\u2014 ${c.phone}. Оператор оставляет за собой право вносить изменения в\u00A0настоящую Политику. Новая редакция вступает в\u00A0силу с\u00A0момента её публикации на сайте.`,
    },
  ];
      ...
      <section className="pt-28 pb-16 px-4 md:px-8 max-w-[1200px] mx-auto">
        <div className="drawing-frame p-6 md:p-10 relative">
          ...
          <div className="font-gost text-[10px] uppercase tracking-[0.2em] text-[var(--drawing-line-thin)] mb-3">
            Правовая информация&nbsp;&middot; Диплом-Инж.рф
          </div>
          ...
          <p className="font-gost text-sm md:text-base max-w-2xl text-[var(--drawing-line-thin)] leading-relaxed">
            Обработка персональных данных посетителей сайта Диплом-Инж.рф
          </p>
        </div>
      </section>
