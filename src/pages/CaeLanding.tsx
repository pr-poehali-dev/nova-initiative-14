...
const FEATURES = [
  {
    icon: "Box",
    title: "3D-редактор рам",
    text: "Рисуйте узлы и элементы прямо в браузере. Snap к сетке, перемещение узлов, библиотека сечений ГОСТ.",
  },
  {
    icon: "Calculator",
    title: "Timoshenko FEM на сервере",
    text: "Полный 3D-расчёт балочных конструкций с учётом сдвиговых деформаций. Эпюры N, Q, M, σ Мизес.",
  },
  {
    icon: "FileText",
...
const CaeLanding = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Диплом-Инж.CAE — облачный расчёт рам и балок на Timoshenko FEM</title>
        <meta
          name="description"
          content="Облачный CAE для машиностроителей: 3D-рамы, библиотека ГОСТ-профилей, эпюры N/Q/M, PDF-отчёт по ЕСКД. Лёгкий, в браузере, без установки. Скоро в раннем доступе."
        />
      ...
      <div className="max-w-[1200px] mx-auto px-4 pt-20 md:pt-24 pb-16">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-base md:text-lg text-[var(--drawing-line-thin)] max-w-2xl mx-auto leading-relaxed mb-3">
            Диплом-Инж.CAE — облачная альтернатива APM&nbsp;WinMachine и&nbsp;ANSYS для машиностроителей. 3D-Timoshenko-балки, ГОСТ-профили, эпюры, ПЗ&nbsp;по ЕСКД.
          </p>
