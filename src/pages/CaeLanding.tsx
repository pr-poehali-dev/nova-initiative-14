...
const FEATURES = [
  ...
  {
    icon: "Zap",
    title: "Нелинейный расчёт P-Δ",
    text: "Учёт геометрической нелинейности (P-Δ эффекты) для оценки устойчивости сжатых стоек и гибких рам. Включается одним тумблером в настройках расчёта.",
  },
];
