    ...
    items: [
      {
        ...
        a: "Нет. Автор\u00A0\u2014 вы. Мы наставляем: объясняем методологию, проверяем вашу работу, разбираем ошибки, показываем как оформлять по стандартам и\u00A0помогаем подготовиться к\u00A0защите. Каждую строчку текста, каждый расчёт и\u00A0каждый чертёж вы делаете сами.",
      },
      {
        id: 2,
        q: "Это этично и законно?",
        a: "Да. Менторское сопровождение\u00A0\u2014 это консультационная услуга, а\u00A0не выполнение работы за студента. Консультации и\u00A0менторство\u00A0\u2014 стандартная практика. Мы помогаем вам разобраться в\u00A0материале и\u00A0прийти к\u00A0самостоятельному решению. Академическая честность\u00A0\u2014 наш принцип.",
      },
      {
        id: 3,
        q: "Чем вы отличаетесь от «написания дипломов на заказ»?",
        a: "Принципиально. Мы не пишем, не делаем чертежи и\u00A0не считаем за вас. Мы помогаем вам сделать это самостоятельно. Наша цель\u00A0\u2014 чтобы вы пришли на защиту, понимая каждый раздел. Это наставничество, а\u00A0не \u00ABуслуга написания\u00BB.",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: 4,
        q: "Как проходят встречи с наставником?",
      ...
      {
        id: 6,
        q: "Что происходит между встречами?",
        a: "Вы работаете по плану: пишете, считаете, чертите. Готовые материалы сдаёте наставнику. Наставник проверяет и\u00A0даёт комментарии. Вопросы\u00A0\u2014 в\u00A0чат (10:00\u201320:00). На следующей встрече\u00A0\u2014 разбор результатов.",
      },
      {
        id: 7,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Есть тариф \u00ABЭкспресс 3\u00A0дня\u00BB\u00A0\u2014 3\u00A0интенсивные консультации. За 3\u00A0дня не переделать с\u00A0нуля, но: разобрать замечания, привести в\u00A0порядок логику, подготовить к\u00A0защите. Чем раньше обратитесь\u00A0\u2014 тем больше успеем.",
      },
      {
        id: 11,
    ...
    items: [
      {
        ...
        a: "Структуру и\u00A0логику глав, формулировки (цель/задачи/объект/предмет), связность расчётов с\u00A0конструкцией и\u00A0текстом, оформление по ЕСКД/ГОСТ/требованиям кафедры, ответы на замечания научрука. Это проверка с\u00A0развёрнутыми пояснениями, не просто \u00ABправильно/неправильно\u00BB.",
      },
      {
        id: 16,
      ...
      },
      {
        ...
        a: "Да. Проверяем оформление по ЕСКД (виды, разрезы, размеры, штампы, спецификации), находим ошибки и\u00A0объясняем. Не делаем чертежи за вас\u00A0\u2014 показываем, как правильно оформлять.",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: 18,
        q: "С какими специальностями работаете?",
        a: "Профиль\u00A0\u2014 машиностроение и\u00A0механика: конструирование деталей и\u00A0узлов машин, технология машиностроения, прикладная механика, детали машин, сварочное производство, CAD/CAE. Если у\u00A0вас смежное инженерное направление\u00A0\u2014 обсудим на\u00A0диагностике.",
      },
      {
        id: 19,
      ...
      },
      {
        ...
        a: "Даём рекомендации по структуре и\u00A0оформлению, показываем примеры (в\u00A0рамках разбора). Не раздаём чужие работы и\u00A0не предоставляем \u00ABготовые шаблоны для копирования\u00BB. Задача\u00A0\u2014 помочь вам сделать свою работу.",
      },
    ],
  },
];
