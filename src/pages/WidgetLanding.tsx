...
const FAQ = [
  ...
  },
  {
    ...
    a: "Подключение по фиксированной абонентской плате, тариф определяется числом расчётов в месяц: «Старт» — 3 900 ₽/мес (до 1 000 расчётов в месяц, 1 сайт), «Бизнес» — 8 900 ₽/мес (до 5 000 расчётов в месяц, до 3 сайтов), «Завод» — 19 900 ₽/мес (до 50 000 расчётов в месяц, безлимит сайтов, интеграция с CRM и брендирование). Дополнительно в любом тарифе можно ограничить число расчётов в сутки на одного посетителя — чтобы лимит расходовался равномерно.",
  },
  {
