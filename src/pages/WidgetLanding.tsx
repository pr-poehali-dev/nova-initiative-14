...
const PLANS = [
  {
    ...
    features: [
      "1 сайт",
      "До 10 расчётов за сессию посетителя",
      "До 20 узлов в схеме",
      "До 30 элементов (стержней)",
      "Заявки на email",
    ],
    accent: false,
  },
  {
    ...
    features: [
      "До 3 сайтов",
      "До 50 расчётов за сессию посетителя",
      "До 50 узлов в схеме",
      "До 80 элементов (стержней)",
  ...
  },
  {
    ...
    features: [
      "Безлимит сайтов",
      "Без лимита расчётов за сессию",
      "До 200 узлов и 400 элементов",
      "Webhook в вашу CRM",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Подключение по фиксированной абонентской плате: «Старт» — 3 900 ₽/мес (1 сайт, до 10 расчётов за сессию посетителя, до 20 узлов), «Бизнес» — 8 900 ₽/мес (до 3 сайтов, до 50 расчётов за сессию, до 50 узлов), «Завод» — по запросу (безлимит расчётов, до 200 узлов, интеграция с CRM и брендирование). Точные условия уточняет менеджер.",
  },
  {
  ...
  },
  {
    ...
    a: "Виджет не перестанет работать. При исчерпании месячного лимита автоматически подключается доп-пакет: +50% к лимиту расчётов и +50% к стоимости тарифа за этот месяц. Мы заранее уведомляем вас письмом при 80% и при исчерпании лимита, а текущий расход всегда виден в личном кабинете партнёра.",
  },
  {
    q: "Как происходит оплата?",
    a: "По постоплате: новый месяц активируется автоматически, даже без оплаты — формируется счёт, который вы оплачиваете по безналу. Это удобно для юридических лиц и не прерывает работу виджета. Баланс, лимит и задолженность вы видите в личном кабинете партнёра.",
  },
];
        ...
        <section id="zakaz" className="scroll-mt-24">
          <div className="grid md:grid-cols-2 gap-6 items-center">
            <div>
              ...
              <a
                href="/partner"
                className="font-gost text-xs text-[var(--drawing-line-thin)] hover:text-[var(--drawing-accent)] inline-flex items-center gap-1"
              >
                <Icon name="User" size={13} /> Уже партнёр? Войти в кабинет
              </a>
            </div>
            <WidgetOrderForm />
          </div>
