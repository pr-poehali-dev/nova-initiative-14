      ...
      <section className="py-16 px-4 md:px-8 bg-[var(--drawing-line)] text-[var(--drawing-bg)]">
        <div className="max-w-[1200px] mx-auto">
          <p className="font-gost text-[10px] uppercase tracking-[0.3em] text-[var(--drawing-bg)] opacity-60 mb-2">
            Экономическая часть&nbsp;&middot; Раздел 04
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="font-gost text-sm text-[var(--drawing-line)] leading-relaxed mb-4">
                  Практикующие инженеры&#8209;конструкторы и&nbsp;инженеры&#8209;технологи. Каждый сегодня работает на&nbsp;производственном предприятии Екатеринбурга&nbsp;&mdash; не&nbsp;теоретик, а&nbsp;действующий специалист в&nbsp;области машиностроения и&nbsp;механики.
                </p>
