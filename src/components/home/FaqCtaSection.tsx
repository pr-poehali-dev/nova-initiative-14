  ...
  const faqData = [
    {
      ...
      a: "Нет. Мы не пишем текст, не делаем чертежи и не выполняем расчёты за студента. Мы разбираем методологию, помогаем выстроить логику, проверяем ваши материалы и готовим к защите. Автор работы — вы.",
    },
    {
      q: "Это этично?",
      a: "Да. Менторское сопровождение — это консультационная услуга. Мы работаем как научный консультант: объясняем, направляем, проверяем. Вы выполняете работу самостоятельно и несёте за неё ответственность.",
    },
    {
    ...
    },
    {
      ...
      a: "Индивидуальные встречи проходят онлайн или в офисе. Вы присылаете материалы — мы проверяем и разбираем на встрече. Между встречами доступна переписка с наставником.",
    },
  ];
      ...
      <section className="py-16 px-4 md:px-8 bg-[var(--drawing-paper)]">
        <div className="max-w-[1200px] mx-auto">
          <p className="font-gost text-[10px] uppercase tracking-[0.3em] text-[var(--drawing-line-thin)] mb-2">
            Справочная часть&nbsp;&middot; Раздел 07
          </p>
