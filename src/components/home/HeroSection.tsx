...
const RobotArmDrawing = () => {
  return (
    <svg
      ...
      className="absolute inset-0 w-full h-full p-4 pointer-events-none select-none"
      aria-hidden="true"
    >
      <g
      ...
      <div className="drawing-frame p-6 md:p-10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10">
          ...
          <div className="md:col-span-5 flex flex-col items-center justify-start">
            <div className="relative w-3/4 md:w-2/3 aspect-square border-[2px] border-[var(--drawing-line)] hatching-blue overflow-hidden -mt-2 md:-mt-4">
              <RobotArmDrawing />
            </div>

            <div className="w-3/4 md:w-2/3 mt-4 border-l-2 border-[var(--drawing-accent)] pl-3">
              ...
              <p className="font-gost-upright text-xl md:text-2xl font-bold tracking-tight leading-tight text-[var(--drawing-line)]">
