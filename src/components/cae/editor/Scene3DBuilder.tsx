 ...
 *
 * Способ ТОЧНОГО ввода в дополнение к рисованию мышью в сцене (режимы «Узел»
 * и «Балка» создают узлы/стержни кликом). Здесь:
 *   - добавить узел по координатам (x, y, z);
 *   - соединить два выбранных в сцене узла стержнем.
 *
 * Панель компактная, висит поверх 3D-сцены справа сверху. Узлы выбираются
