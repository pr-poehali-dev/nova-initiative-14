...
/**
 * Порог в пикселях, после которого нажатие на узел считается перетаскиванием,
 * а не кликом. Пока сдвиг меньше порога — это клик (выбор/снятие выбора),
 * больше — drag&drop узла. Разделяет два жеста, чтобы они не перебивали друг друга.
 */
