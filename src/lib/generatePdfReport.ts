...
function drawDiagramOverScheme(
  ...
  // ЕДИНЫЙ глобальный масштаб эпюр (тикет №39): один коэффициент k для всех
  // стержней. Высота откладывается строго пропорционально значению, поэтому
  // в общем узле эпюры соседних балок совпадают (−10 Н·м и +10 Н·м ложатся
  // в одну точку), а соотношение усилий между стержнями отражено честно.
  ...
  // Один общий коэффициент «значение → мм»: самый большой пик по всей раме
