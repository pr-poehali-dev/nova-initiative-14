...
const CAE_3D_ROADMAP: Roadmap = {
  ...
  phases: [
    ...
    },
    {
      ...
      icon: "Boxes",
      horizon: "В работе",
      summary: "Для 3D-проектов вместо 2D SVG показывается настоящая трёхмерная сцена на three.js с орбита-камерой и выбором элементов.",
      tasks: [
        ...
        { title: "Фиксированные виды (спереди/сбоку/сверху)", status: "next", note: "Сейчас изометрия + ViewCube; добавить быстрые кнопки видов." },
      ],
    },
    {
      key: "input-3d",
