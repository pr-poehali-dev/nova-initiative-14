...
/**
 * Готовые рекламные носители (utm_source) с пояснениями.
 * Флаер и листовка — разные форматы: флаер мелкий, раздают из рук;
 * листовка крупнее, кладут на стойки/раскладывают; плакат — для стен.
 */
export const AD_SOURCES = [
  {
    value: "flyer",
    label: "Флаер",
    desc: "Мелкий рекламный листок (А6/А7), раздают из рук у входа, на мероприятиях.",
  },
  {
    value: "leaflet",
    label: "Листовка",
    desc: "Формат покрупнее (А5/DL), раскладывают на стойках, столах, в точках выдачи.",
  },
  {
    value: "poster",
    label: "Плакат",
    desc: "Большой формат для размещения на стене или доске — издалека и надолго.",
  },
  {
    value: "stand",
    label: "Стенд / доска",
    desc: "Размещение на информационном стенде или доске объявлений.",
  },
  {
    value: "partner",
    label: "Партнёрская точка",
    desc: "Раздача через партнёра (кафе, коворкинг, магазин и т.п.).",
  },
] as const;
